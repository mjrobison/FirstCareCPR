...
<!-- <div class="search">[event_search_form]<?php //require_once('search/search.php'); ?></div> -->
<div class="nextCourses">
	<h3>Upcoming Courses</h3>
	<h4>CPR Courses</h4>
	<p>[events_list category="cpr" limit="5"]#_EVENTLINK - #_EVENTDATES at #_EVENTTIMES<br />[/events_list]
	<h4>First Aid Courses</h4>
	<p>[events_list category="first-aid" limit="5"]#_EVENTLINK - #_EVENTDATES at #_EVENTTIMES<br />[/events_list]
	<h4>Blood Borne Pathogens Courses</h4>
	<p>[events_list category="pathogens" limit="5"]#_EVENTLINK - #_EVENTDATES at #_EVENTTIMES<br />[/events_list]
	<h4>Survival/Wilderness Courses</h4>
	<p>[events_list category="wilderness" limit="5"]#_EVENTLINK - #_EVENTDATES at #_EVENTTIMES<br />[/events_list]
	<h4>Health Care Provider CPR Courses</h4>
	<p>[events_list category="health-care-provider-cpr" limit="5"]#_EVENTLINK - #_EVENTDATES at #_EVENTTIMES<br />[/events_list]
	<h4>Early Childhood Emergency Courses</h4>
	<p>[events_list category="early-childhood" limit="5"]#_EVENTLINK - #_EVENTDATES at #_EVENTTIMES<br />[/events_list]
	<!--<p>[events_list_grouped mode="category" country="US"]#_EVENTLINK - #_EVENTDATES at #_EVENTTIMES<br />[/events_list_grouped]</p>-->
